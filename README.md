...
| CI/CD                      | One of the following: <ul><li>[GitHub Actions](https://github.com/actions) workflows to test and deploy ML code and resources</li><li>[Azure DevOps](https://azure.microsoft.com/en-gb/products/devops/) to test and deploy ML code and resources</ul>              | Ship ML code faster and with confidence: ensure all production changes are performed through automation and that only tested code is deployed to prod                                   |
