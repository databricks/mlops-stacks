...
mlp_paths = [
    ...
    os.path.join(project_name, "tests", "development", "training", "test_sample.parquet"),
...
feature_store_paths = [
    ...
    os.path.join(project_name, "development", "training", "notebooks", "TrainWithFeatureStore.py"),
