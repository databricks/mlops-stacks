...
def parametrize_by_project_generation_params(fn):
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("azure", "github_actions_for_github_enterprise_servers", "no", "no", "yes"),
            ("azure", "github_actions_for_github_enterprise_servers", "no", "yes", "no"),
            ("azure", "github_actions_for_github_enterprise_servers", "yes", "no", "no"),
