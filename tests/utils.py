...
def parametrize_by_project_generation_params(fn):
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("aws", "Github Actions for Enterprises", "no"),
            ("azure", "Github Actions for Enterprises", "no"),
            ("aws", "Github Actions for Enterprises", "yes"),
            ("azure", "Github Actions for Enterprises", "yes"),
