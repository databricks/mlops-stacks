...
and [ML resource config guide](%7B%7Bcookiecutter.project_name%7D%7D/terraform/README.md) to propose, test, and deploy changes to production ML code (e.g. update model parameters)
...
| Data Scientist                | Modify production model ML resources, e.g. model training or inference jobs   | [ML resource config guide](%7B%7Bcookiecutter.project_name%7D%7D/terraform/README.md)                                                                                                                   |
